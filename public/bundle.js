...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	var div, p0, t0, code0, t2, t3, p1, t4, code1, t6, code2, t8, t9, pre, code3, t11, p2, t12, code4, t14, code5, t16, code6, t18, t19, p3, t20, the, t21, code7, t23, code8, t25, code9, t27, code10, t29, t30, p4, t31, code11, t33, code12, t35, div_intro;
    	...
    	const block = {
    		c: function create() {
    			...
    			t31 = text("The ");
    			code11 = element("code");
    			code11.textContent = "infoStore.js";
    			t33 = text(" file also contains the site’s styling configuration. You can change the\nlook of your site from the ");
    			code12 = element("code");
    ...
    function instance$3($$self, $$props, $$invalidate) {
      ...
      function processData(data) {
        ...
        //
        const linfo = get_store_value(info);
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div = element("div");
    			p0 = element("p");
    			t0 = text("Created using ");
    			a = element("a");
    			a.textContent = "SvelteWeb";
    			t2 = space();
    			p1 = element("p");
    ...
    // (20:4) {#if styles.showSideBar && styles.sideBarLeft}
    function create_if_block_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_if_block_1$1.name, type: "if", source: "(20:4) {#if styles.showSideBar && styles.sideBarLeft}", ctx });
    	return block;
    }

    // (24:4) {#if styles.showSideBar && !styles.sideBarLeft}
    function create_if_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_if_block$1.name, type: "if", source: "(24:4) {#if styles.showSideBar && !styles.sideBarLeft}", ctx });
    	return block;
    }

    function create_fragment$a(ctx) {
    	var title_value, link_1, t0, div3, header, t1, div0, h1, t2, t3, h3, t4, t5, div1, t6, t7, div2, t8, t9, t10, current;

    	document_1.title = title_value = ctx.siteName;

    	var logo = new Logo({ $$inline: true });

    	var navbar = new NavBar({ $$inline: true });

    	var if_block0 = (ctx.styles.showSideBar && ctx.styles.sideBarLeft) && create_if_block_1$1(ctx);
    	...
    	var if_block1 = (ctx.styles.showSideBar && !ctx.styles.sideBarLeft) && create_if_block$1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(link_1, file$9, 2, 2, 44);
    			add_location(h1, file$9, 11, 6, 520);
    			add_location(h3, file$9, 12, 6, 546);
    			attr_dev(div0, "id", "title");
    			attr_dev(div0, "class", "svelte-1n11mfo");
    			add_location(div0, file$9, 10, 4, 497);
    			attr_dev(div1, "id", "spacer");
    			attr_dev(div1, "class", "svelte-1n11mfo");
    			add_location(div1, file$9, 14, 4, 579);
    			...
    			attr_dev(header, "class", "svelte-1n11mfo");
    			add_location(header, file$9, 6, 2, 211);
    			attr_dev(div2, "id", "main");
    			attr_dev(div2, "class", "svelte-1n11mfo");
    			add_location(div2, file$9, 18, 2, 635);
    			attr_dev(div3, "id", "page");
    			set_style(div3, "background-color", ctx.styles.backgroundColor);
    			set_style(div3, "font", ctx.styles.font);
    			attr_dev(div3, "class", "svelte-1n11mfo");
    			add_location(div3, file$9, 5, 0, 120);
    		},
    		...
    		m: function mount(target, anchor) {
    			append_dev(document_1.head, link_1);
    ...
    function instance$9($$self, $$props, $$invalidate) {
      ...
      onMount(() => {
    	...
    	return { routes, siteName, byLine, styles };
    }
