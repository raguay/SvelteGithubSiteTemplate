...
var app = (function () {
    ...
    /* src/components/About.svexy generated by Svelte v3.12.1 */

    const file = "src/components/About.svexy";

    function create_fragment(ctx) {
    	var div, h2, t1, p0, t3, p1, t4, code, t6, div_intro;
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			p0 = element("p");
    			p0.textContent = "This is a markdown file with information about you. Change as\nyou see fit.";
    			t3 = space();
    			p1 = element("p");
    			t4 = text("The ");
    			code = element("code");
    			code.textContent = "div";
    			t6 = text(" setup the proper styling for the markdown and controls\nthe animation of it on the site.");
    			add_location(h2, file, 1, 0, 46);
    			add_location(p0, file, 2, 0, 64);
    			add_location(code, file, 4, 7, 153);
    			add_location(p1, file, 4, 0, 146);
    			attr_dev(div, "class", "box svelte-1nhe571");
    ...
    /* src/components/Index.svexy generated by Svelte v3.12.1 */

    const file$1 = "src/components/Index.svexy";

    function create_fragment$1(ctx) {
    	var div, p0, t0, code0, t2, t3, p1, t4, code1, t6, code2, t8, t9, pre, code3, t11, p2, t12, code4, t14, code5, t16, code6, t18, t19, p3, t20, the, t21, code7, t23, code8, t25, code9, t27, code10, t29, div_intro;

    	const block = {
    		c: function create() {
    			div = element("div");
    			p0 = element("p");
    			t0 = text("This markdown file contains the front page for your site. Everything in this\nfile will be in the main content area. This file and the ");
    			code0 = element("code");
    			code0.textContent = "About.svexy";
    			...
    			t3 = space();
    			p1 = element("p");
    			t4 = text("The template is setup to run in development mode. To run from GitHub, you need to\nedit the ");
    			code1 = element("code");
    			code1.textContent = "infoStore.js";
    			t6 = text(" file in the ");
    			code2 = element("code");
    			code2.textContent = "store";
    			t8 = text(" directory. The items you have to change\nis:");
    			t9 = space();
    			pre = element("pre");
    			code3 = element("code");
    			code3.textContent = "GitHub: '<the address of the site directory in raw mode>',\nlocal: false";
    			t11 = space();
    			p2 = element("p");
    			t12 = text("The other fields are display on the website and should already be changed. With the\nabove changes, you can run ");
    			code4 = element("code");
    			code4.textContent = "mask build";
    			t14 = text(", commit the changes in the ");
    			code5 = element("code");
    			code5.textContent = "launch";
    			t16 = text(" directory,\nand run ");
    			code6 = element("code");
    			code6.textContent = "git push";
    			t18 = text(" to push it to your site.");
    			t19 = space();
    			p3 = element("p");
    			t20 = text("To get ‘");
    			the = element("the");
    			t21 = text("’, you first have to commit the\nbasic site to your GitHub pages repository, navigate to the ");
    			code7 = element("code");
    			code7.textContent = "launch/site";
    			t23 = text(" folder on\nGitHub, and then click the ");
    			code8 = element("code");
    			code8.textContent = "raw";
    			t25 = text(" button. The address in your browser should have\nthe full address to the ");
    			code9 = element("code");
    			code9.textContent = "site";
    			t27 = text(" directory in raw mode. Copy and paste that address into\nthe ");
    			code10 = element("code");
    			code10.textContent = "infoStore.js";
    			t29 = text(" file as mentioned above.");
    			add_location(code0, file$1, 2, 57, 183);
    			add_location(p0, file$1, 1, 0, 46);
    			add_location(code1, file$1, 7, 9, 481);
    			add_location(code2, file$1, 7, 47, 519);
    			add_location(p1, file$1, 6, 0, 387);
    			attr_dev(code3, "class", "language-sh");
    			add_location(code3, file$1, 9, 5, 591);
    			add_location(pre, file$1, 9, 0, 586);
    			add_location(code4, file$1, 13, 27, 823);
    			add_location(code5, file$1, 13, 78, 874);
    			add_location(code6, file$1, 14, 8, 913);
    			add_location(p2, file$1, 12, 0, 709);
    			add_location(code7, file$1, 16, 60, 1114);
    			add_location(code8, file$1, 17, 27, 1176);
    			add_location(code9, file$1, 18, 24, 1265);
    			add_location(code10, file$1, 19, 4, 1343);
    			attr_dev(the, "address", "");
    			attr_dev(the, "of", "");
    			attr_dev(the, "the", "");
    			attr_dev(the, "site", "");
    			attr_dev(the, "directory", "");
    			attr_dev(the, "in", "");
    			attr_dev(the, "raw", "");
    			attr_dev(the, "mode", "");
    			add_location(the, file$1, 15, 11, 975);
    			add_location(p3, file$1, 15, 0, 964);
    			attr_dev(div, "class", "box svelte-4ra9n9");
    		...
    		m: function mount(target, anchor) {
    			...
    			append_dev(p3, the);
    			append_dev(the, t21);
    			append_dev(the, code7);
    			append_dev(the, t23);
    			append_dev(the, code8);
    			append_dev(the, t25);
    			append_dev(the, code9);
    			append_dev(the, t27);
    			append_dev(the, code10);
    			append_dev(the, t29);
    		},
    ...
    class Router extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment$2, safe_not_equal, ["routes"]);
    ...
    function create_catch_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_catch_block.name, type: "catch", source: "(1:0) {#await promise}", ctx });
    	return block;
    }
    ...
    function create_then_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(content, file$2, 5, 2, 125);
    		},
    ...
    function create_pending_block(ctx) {
    	var content, p, content_intro;

    	const block = {
    		c: function create() {
    			content = element("content");
    			p = element("p");
    			p.textContent = "Loading page...";
    			attr_dev(p, "id", "waiting");
    			attr_dev(p, "class", "svelte-p5dd26");
    			add_location(p, file$2, 2, 4, 61);
    			attr_dev(content, "class", "svelte-p5dd26");
    ...
    function instance$1($$self, $$props, $$invalidate) {
      ...
      function processData(data) {
    	...
    	$$self.$capture_state = () => {
    		return { params, converter, page, promise };
    	};
    	...
    	return { params, promise, processData };
    }

    class Page extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$3, safe_not_equal, ["params"]);
    ...
    /* src/components/Logo.svelte generated by Svelte v3.12.1 */
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(svg, "viewBox", "0 0 100 81");
    			...
    			set_style(svg, "stroke-miterlimit", "1.41421");
    			attr_dev(svg, "class", "svelte-z9ob7v");
    ...
    class Logo extends SvelteComponentDev {
    	constructor(options) {
    		...
    		dispatch_dev("SvelteRegisterComponent", { component: this, tagName: "Logo", options, id: create_fragment$4.name });
    	}
    }

    /* src/components/Twitter.svelte generated by Svelte v3.12.1 */

    const file$4 = "src/components/Twitter.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "id", "twitter");
    			attr_dev(div, "class", "svelte-rdi7ft");
    ...
    class Twitter extends SvelteComponentDev {
    	constructor(options) {
    		...
    		dispatch_dev("SvelteRegisterComponent", { component: this, tagName: "Twitter", options, id: create_fragment$5.name });
    	}
    }

    /* src/components/BlogPosts.svelte generated by Svelte v3.12.1 */

    const file$5 = "src/components/BlogPosts.svelte";
    ...
    class BlogPosts extends SvelteComponentDev {
    	constructor(options) {
    		...
    		dispatch_dev("SvelteRegisterComponent", { component: this, tagName: "BlogPosts", options, id: create_fragment$6.name });
    	}
    }
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			p.textContent = "Place the line you copy from Twitter for embedding your twitter account.";
    			add_location(p, file$6, 2, 4, 35);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_default_slot.name, type: "slot", source: "(2:2) <Twitter>", ctx });
    	return block;
    }
    ...
    function create_fragment$7(ctx) {
    	...
    	var blogposts = new BlogPosts({ $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			twitter.$$.fragment.c();
    			t = space();
    			blogposts.$$.fragment.c();
    			attr_dev(div, "id", "sidebar");
    			attr_dev(div, "class", "svelte-1u2lu13");
    		...
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			mount_component(twitter, div, null);
    			append_dev(div, t);
    			mount_component(blogposts, div, null);
    			current = true;
    		},
    		...
    		i: function intro(local) {
    			...
    			transition_in(blogposts.$$.fragment, local);
    		...
    		o: function outro(local) {
    			...
    			transition_out(blogposts.$$.fragment, local);
    			current = false;
    		},
     ...
     */
    function active$1(node, path, className) {
    ...
    const file$7 = "src/WebSite.svelte";

    function create_fragment$8(ctx) {
    	var title_value, link_1, t0, div5, header, t1, div0, h1, t2, t3, h3, t4, t5, div1, t6, div2, a0, link_action, active_action, t8, a1, link_action_1, active_action_1, t10, a2, link_action_2, active_action_2, t12, div3, t13, t14, footer, div4, p0, t15, a3, t17, p1, current;

    	document.title = title_value = ctx.siteName;
    	...
    	const block = {
    		c: function create() {
    			...
    			div4 = element("div");
    			p0 = element("p");
    			t15 = text("Created using ");
    			a3 = element("a");
    			a3.textContent = "SvelteWeb";
    			t17 = space();
    			p1 = element("p");
    			p1.textContent = "Copyrighted by";
    			attr_dev(link_1, "rel", "icon");
    			attr_dev(link_1, "type", "image/png");
    			attr_dev(link_1, "href", "/imgs/favicon.png");
    			add_location(link_1, file$7, 2, 2, 44);
    			add_location(h1, file$7, 9, 6, 187);
    			add_location(h3, file$7, 10, 6, 213);
    			attr_dev(div0, "id", "title");
    			attr_dev(div0, "class", "svelte-1se8z90");
    			add_location(div0, file$7, 8, 4, 164);
    			attr_dev(div1, "id", "spacer");
    			attr_dev(div1, "class", "svelte-1se8z90");
    			add_location(div1, file$7, 12, 4, 246);
    			attr_dev(header, "class", "svelte-1se8z90");
    			add_location(header, file$7, 6, 2, 138);
    			attr_dev(a0, "class", "navItem svelte-1se8z90");
    			attr_dev(a0, "href", "/");
    			add_location(a0, file$7, 16, 4, 311);
    			attr_dev(a1, "class", "navItem svelte-1se8z90");
    			attr_dev(a1, "href", "/blog/index");
    			add_location(a1, file$7, 17, 4, 372);
    			attr_dev(a2, "class", "navItem svelte-1se8z90");
    			attr_dev(a2, "href", "/about");
    			add_location(a2, file$7, 18, 4, 443);
    			attr_dev(div2, "id", "navbar");
    			attr_dev(div2, "class", "svelte-1se8z90");
    			add_location(div2, file$7, 15, 2, 289);
    			...
    			attr_dev(footer, "class", "svelte-1se8z90");
    			add_location(footer, file$7, 24, 2, 584);
    			attr_dev(div5, "id", "page");
    			attr_dev(div5, "class", "svelte-1se8z90");
    			add_location(div5, file$7, 5, 0, 120);
    		},
    		...
    		p: function update(changed, ctx) {
    			if ((!current || changed.siteName) && title_value !== (title_value = ctx.siteName)) {
    ...
    class WebSite extends SvelteComponentDev {
    	constructor(options) {
    		...
    		dispatch_dev("SvelteRegisterComponent", { component: this, tagName: "WebSite", options, id: create_fragment$8.name });
    	}
    }
